...
//
// TODO: Extend the AtlasCliTest service by defining new RPCs and
...
//
// TODO: Create an implementation of the AtlasCliTest server
...
// implementation of AtlasCliTest server interface service, but only
...
// Default implementation of the AtlasCliTest server interface
...
func NewBasicServer(database *gorm.DB) (pb.AtlasCliTestServer, error) {
	return &server{db: database}, nil
}

type accountsServer struct {
	*pb.AccountsDefaultServer
}

// NewAccountsServer returns an instance of the default Account server interface
func NewAccountsServer(db *gorm.DB) (pb.AccountsServer, error) {
	return &accountsServer{&pb.AccountsDefaultServer{db}}, nil
}
...
// NewGroupsServer returns an instance of the default Group server interface
func NewGroupsServer(db *gorm.DB) (pb.GroupsServer, error) {
	return &groupsServer{&pb.GroupsDefaultServer{db}}, nil
}
